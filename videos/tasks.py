...
@app.task(bind=True)
def get_transcript_score_async(self, json_transcript, user_id, start_time, end_time, description, video_id, start, end):
    try:
        transcript_score = get_transcript_score(json_transcript, start, end, description)
    except Exception:
        transcript_score = 0
